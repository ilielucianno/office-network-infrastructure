...
Detailed migration steps are documented in [docs/migration-notes.md](docs/migration-notes.md).
...
| SSH brute-force attack | Wazuh Active Response blocks the IP automatically |
| Need for alert automation | Shuffle SOAR receives webhook alerts for orchestration |
...
### What I Know I Want to Learn
  ...
  * **Complete Shuffle workflow** — Build automated ticket creation and incident response playbooks
